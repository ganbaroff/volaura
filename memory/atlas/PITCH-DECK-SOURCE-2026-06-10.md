...
## RESOLVED 2026-06-10 (was: two CEO confirms — both now closed)
1. **Ask framing → DECIDED** (CEO delegated the call to Atlas; strange-protocol adversary-tested). The deck is **NOT** a "raising $X" deck. Frame = **"paid proof first, accelerator second."** Ask slide = *"Seeking 2 design-partner employers + a data-consent legal clear — to turn a live assessment engine into proven hiring outcomes."* Path: (1) 90-day = **2 PAID token-price pilots with CORPORATE HR buyers** reached via Yusif's COP29/WUF13 network (NOT event-ops orgs as the buyer — that dilutes positioning); (2) ~**$3k local counsel** to clear AZ data-consent (the real blocker — cash, not credits); (3) **GITA** grant parallel for eng; (4) accelerator (YC S27/Techstars) + Series A $500K–1M = **future signals**, applied-to WITH traction. Full reasoning + adversary failure-modes: **`memory/atlas/STRATEGY-fundraise-path-2026-06-10.md`**.
2. **Founder bio → RESOLVED.** Use the concrete **COP29 (66k) / CIS Games 2025 (5k) / WUF13 (15k)** framing — PMP, $10M+ budgets, 220+ volunteers. Canonical source: **`memory/atlas/founder-profile.md`** (built from his real CV). The vague "civil society / digital transformation" wording is retired.
...
11. **Team + Ask** — Yusif Ganbarov, Founder/CEO (bio: `memory/atlas/founder-profile.md`), solo + AI-augmented; hiring React+Python devs (GITA-grant-funded); B2B sales = CEO. Advisors [Pending]. **Ask = 2 design-partner employers + a data-consent legal clear** (see RESOLVED #1 + `STRATEGY-fundraise-path-2026-06-10.md`); accelerator / Series A = future signal, not a current $-ask.
