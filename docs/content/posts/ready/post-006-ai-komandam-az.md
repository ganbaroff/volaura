# Post 006 — TikTok AZ — "AI komandam mənim kodumu yoxladı"

**Status:** READY
**Platform:** TikTok
**Language:** AZ
**Hook type:** Data
**Scheduled:** Tuesday April 14, 2026 (post anytime today; LinkedIn pairs at 20:00 Baku)
**Length:** 40-50 sec
**Render:** `pnpm --filter @volaura/remotion render -- TikTokAZ out/tiktok-2026-04-14.mp4`
(data file: `packages/remotion/src/data/tiktok-2026-04-13.ts` — repurpose, update date)
...
- No flashy transitions; respect prefers-reduced-motion (Constitution Law 4)
...
- [x] AZ version culturally native? — yes: collectivist framing, formal-warm tone, no comparison of AZ tech to West, "biz/komanda" emphasis, native idiom («bilirsiz?»)
- [x] Hook rotation respected? — Data hook; pairs with EN Contrarian today (different types)
- [x] Constitution: no red, shame-free, one CTA, motion-safe
