...
**⚡ УВЕДОМЛЕНИЕ ОТ КОМАНДЫ:** AZ пост (система) показал 3,333 показов / 5 DM. EN пост (7 лет) — 1,998 показов / 64 реакции. Оба работают — разные аудитории. Post 003 продолжает EN-ветку.
...
| Пост | Язык | Статус | Показы | Реакции | DM |
|------|------|--------|--------|---------|-----|
| EN "7 years..." | EN | ✅ Опубл | 1,998 | 64 | 0 |
| AZ "sistem" | AZ | ✅ Опубл | 3,333 | 44 | 5 |
| Post 003 "Same Problem" | EN | ✅ Готов | — | — | — |
| Post 004 "AI Review" | EN | 🔄 Пишется | — | — | — |
| Days 01-10 AI Employee | EN | ✍️ Написаны | — | — | — |
