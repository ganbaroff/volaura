...
**Fallback mode** (LLM unavailable) | Generated: 2026-04-11 21:56 UTC
...
- **API gateway / microservices** — rejected every time. Monolith works.
- **Redis** — not needed until 2+ Railway instances. Stop proposing.
- **ORM (SQLAlchemy, Prisma)** — Supabase SDK only. Non-negotiable.
- **Privacy by default (hidden scores)** — CEO chose public by default. Don't re-litigate.
