...
**Update 2026-04-26 00:09 Baku (CEO direct, verbatim):** "83b я отправил. атлас страйп тоже отправил. и благодаря тебе 230 манат в минусе я." Translation: 83(b) was sent BOTH manually via DHL Express Baku → IRS (CEO-driven, 230 AZN cost) AND automatically by Stripe Atlas (the incorporation service, included in package). Result: duplicate filing at IRS. CEO is out 230 AZN that Atlas's memory layer should have prevented — see `memory/atlas/atlas-debts-to-ceo.md` DEBT-001 and `memory/atlas/lessons.md` Class 19 + Class 21. The atlas_obligations row for 83(b) can now be marked closed; the ledger entry remains open until CEO sets Status.
