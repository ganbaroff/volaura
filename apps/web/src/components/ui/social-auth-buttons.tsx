...
export function SocialAuthButtons({ redirectTo, meta }: SocialAuthButtonsProps) {
      ...
      <div className="grid grid-cols-2 gap-3">
        {PROVIDERS.map((provider) => (
          <button
            ...
            className="flex h-10 items-center justify-center gap-2 rounded-md border border-border bg-background px-3 text-sm font-medium transition-colors hover:bg-muted disabled:opacity-50"
          >
            {loading === provider ? (
