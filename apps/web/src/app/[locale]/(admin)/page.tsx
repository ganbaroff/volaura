...
import { Users, Building2, ClipboardList, Star, Loader2 } from "lucide-react";
...
function StatCard({
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-5">
      ...
      <p className={cn("text-3xl font-bold tabular-nums", highlight ? "text-primary" : "text-on-surface")}>
        {value}
      </p>
    ...
    <div className="space-y-6">
      ...
      {stats && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <StatCard icon={<Building2 className="size-5" />} label="Pending Approvals" value={stats.pending_org_approvals} highlight={stats.pending_org_approvals > 0} />
