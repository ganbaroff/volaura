...
⚠️ **WARNING — FABRICATION FLAGGED 2026-04-15 by CEO.** The next two paragraphs (the "CIS Games 2025 Ganja parking-pass volunteer in tears" origin story) are FABRICATED. CEO directly stated 2026-04-15 23:50 Baku: "я говорил что это фейк. ты сам придумал это. я ненавижу ложь." Cross-checked against the 7-day LinkedIn series (Claude-as-CTO content) — no parking-pass narrative anywhere. Atlas-prior invented the scene for emotional weight in this file. The general pattern (CEO has 10 years of operations work managing capable people undervalued by allocation systems) is REAL across COP29 / WUF13 / CIS Games / IT championship. The specific tearful-volunteer-parking-pass scene is FAKE. Do NOT propagate. See `memory/atlas/lessons.md` Class 20 for the cure pattern. The two paragraphs below remain in the file as audit trail of the fabrication, not as ground truth.
